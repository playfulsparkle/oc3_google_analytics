...
Thank you for your interest in contributing to the Playful Sparkle Google Analytics extension! We value contributions from the community to enhance this project for all users. Whether you're fixing bugs, adding features, improving documentation, or translating the extension, your efforts are greatly appreciated.
...
1. Review the [existing issues](https://github.com/playfulsparkle/oc3_google_analytics/issues) to avoid duplicates, or open a ticket on the [support page](https://support.playfulsparkle.com/).
...
- Follow best practices for JavaScript, including ES6+ syntax where applicable.
...
- Validate edge cases, such as different currencies, order totals, or tracking scenarios.
- Confirm that your changes do not conflict with core OpenCart functionality or Google Analytics integration.
...
- [GitHub Issues](https://github.com/playfulsparkle/oc3_google_analytics/issues)
